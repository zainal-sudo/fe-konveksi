  ...
  },
  {
    ...
    children: [
      ...
      
      {
        ...
        route: "/transaksi/invoice",
        menuId: "12", // ⚠️ GANTI sesuai ID menu "Invoice" di tabel menu/thakuser kamu
      },
	   {
      ...
      },
	 {
        ...
        icon: IconTruckDelivery,
        route: "/transaksi/bayarSupplier",
        menuId: "53",
      },
      {
        title: "Penyesuaian Stok",
        icon: IconAdjustments,
        route: "/transaksi/penyesuaian-stok",
        menuId: "27",
      },
      {
  title: "STBJ",
  icon: IconTruckDelivery,
  route: "/transaksi/stbj",
  menuId: "40",
},      
{
  title: "Mutasi Gudang",
  icon: IconTruckDelivery,
  route: "/transaksi/mutasi",
  menuId: "13",
},
...
<template>
  <v-app>
      ...
      <div class="drawer-brand" :class="{ 'rail-brand': rail }">
        ...
        <transition name="fade">
          <div v-if="isMobile || !rail" class="brand-text">
            <div class="brand-title">E R P</div>
    ...
    <v-app-bar flat class="finance-appbar" height="52">
      ...
      <v-app-bar-title>
        <span class="appbar-title">Sistem E R P</span>
      </v-app-bar-title>
